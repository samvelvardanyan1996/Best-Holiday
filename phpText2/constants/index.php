<?php
  define('ALL_INCLUSIVE_TITLE', 'All Inclusive');
  define('ULTRA_ALL_INCLUSIVE_TITLE', 'Ultra All Inclusive');
  define('CRAZZY_ALL_INCLUSIVE_TITLE', 'Crazzy All Inclusive');

  define('ALL_INCLUSIVE_DESC', '
    <p><span style="font-size:11pt"><span style="font-family:NotoSansArmenian-Regular"><span style="color:#000000">В рамках выбранного тур пакета<br />
      ...
      7. Персональный Гид 24ч</span></span></span>
    </p>

    <h1><strong><span style="font-size:11pt"><span style="font-family:NotoSansArmenian-Regular"><span style="color:#000000">1 DAY - 1000&euro;</span></span></span></strong></h1>

    <p><span style="font-size:11pt"><span style="font-family:NotoSansArmenian-Regular"><span style="color:#000000">Within the selected tour package<br />
      ...
      7. Personal Guide 24h</span></span></span>
    </p>
  ');
  define("ULTRA_ALL_INCLUSIVE_DESC", '
    ...
    <p>&nbsp;</p>
  ');
  define("CRAZZY_ALL_INCLUSIVE_DESC", '
    <p>
