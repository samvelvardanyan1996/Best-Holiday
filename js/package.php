...
-->
  ...
  <style>
    ...
    #footer a.facebook {
      background-color: #5e5ea2 !important;
    }
  </style>
  <script>
...
<body id="bg">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="sights.php" class="nav-link">Sights</a></li>
          <li class="nav-item"><a href="tours.php" class="nav-link">Tours Packages</a></li>
      ...
      <div class="container">
        <div class="row slider-text align-items-center">
          <div class="col-md-7 col-sm-12 ftco-animate">
            ...
            <h1 class="mb-3">Tours Packages</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="bg-primary m-b100">
    <div class="block-17 pt-3 pb-4">
      <form name="chechinForm" onsubmit="submitCheckin(event)" id="chechinForm">
        <!-- <div class="d-lg-flex fields mb-3 addCalcTour" style="margin: 0 auto;">
          <div class="check-in one-third"><input type="text" id="checkin_date" class="form-control" placeholder="Check-in date"></div>
          <div class="one-third"><input type="number" class="form-control" placeholder="Traveler"></div>
          <div class="one-third">
            <select class="numbersChildren form-control">
        ...
        <!-- <div class="d-lg-flex fields  mb-3" style="margin: 0 auto;">
          <div class="one-third2">All inclusive<input style="opacity: 1;margin-top: 9px;margin-left: 5px !important;" type="checkbox" class="btn btn-primary"></div>
          <div style="width: 22%;" class="one-third2">Ultra All Inclusive<input style="opacity: 1; margin-top: 9px; margin-left: 5px !important;" type="checkbox" class="btn btn-primary"></div>
          <div style="width: 22%;" class="one-third2">Crazzy All Inclusive<input style="opacity: 1; margin-top: 9px; margin-left: 5px !important;" type="checkbox" class="btn btn-primary"></div>
          <input style="width: 18.5%; height: 52px; margin-top: 0; margin-left: -1%;" type="submit" class="m-t10 one-third search-submit btn btn-primary" value="Submit">
        </div> -->
          ...
          <div class="container">
            ...
            $days_title_array = [
              1 => [
                ...
                "Yerevan - moving to Urtsadzor village - Training",
              ...
              2 => [
                "Airport - Yerevan City Tour",
                "Yerevan - Noravank Monastery - Arates Monastery - Hermon Village",
                ...
                "Caravanserai - Madina - Noratus - Sevanavank - Yerevan",
                "Yerevan - airport"
              ],
              3 => [
                "Airport - Yerevan City tour",
                ...
                "Yerevan - Sevan - Dilijan - Haghartsin - Goshavank – Yerevan",
                "Yerevan - Saghmosavank - Fortress of Amberd - Byurakan Observatory -  Yerevan",
                "The Republic Square - Echmiadzin - Zvartnots - Brandy Factory",
                "Parajanov Museum - Vernissage - Central Market",
              ],
              4 => [
                "Airport - A walk in Yerevan",
                "Yerevan - Garni - Geghard – Yerevan",
                "Yerevan - Khor Virap - Noravanq - Tatev Monastery – Stepanakert",
                "Stepanakert - Gandzasar - Dadivank – Tigranakert – Stepanakert",
                "Stepanakert - Shushi - Khndzoresk - Karahunj – Yerevan",
                "Yerevan - Sevan - Dilijan - Haghartsin - Goshavanq – Yerevan",
                "Yerevan - Matenadaran - Echmiadzin - airport",
              ],
              5 => [
              ...
              6 => [
                ...
                "Yerevan - Sevan - Dilijan - Haghartsin - Goshavank – Yerevan",
                "The Republic Square - Echmiadzin - Zvartnots – Airport",
              ],
            ];
                ...
                <div class="col-md-9 col-lg-10">
                  <div class="day-details-bx">
                    <div class="row">
                      ...
                      <div class="col-md-12 col-lg-6">
                        <img src="/images/horse_tour/horse_tour.jpg" class="radius-sm" alt="" />
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <script>
    ...
    let number;
    // $(".numbersChildren").click(function() {
    //   if ($(this).val() == '1 child') {
    //     number = 0;
    //     $('.addCalcTourJquery').remove();
    //     for (let i = 0; i <= number; i++) {
    //       $('.addCalcTour').append('<div class="addCalcTourJquery one-third2 widthAuto" style="position: absolute;right: ' + (180 - i * 90) + 'px;padding: 0;"><div> 0 - 10<input style="opacity: 1;margin-top: 9px;margin-left: 5px !important;" type="radio" class="btn btn-primary" name="age' + i + '"></div><div>10 - 18 <input style="opacity: 1;margin-top: 9px;margin-left: 5px !important;" type="radio" class="btn btn-primary" name="age' + i + '"></div>');
    //     }
    //   } else if ($(this).val() == '2 children') {
    //     number = 1;
    //     $('.addCalcTourJquery').remove();
    //     for (let i = 0; i <= number; i++) {
    //       $('.addCalcTour').append('<div class="addCalcTourJquery one-third2 widthAuto" style="position: absolute;right: ' + (180 - i * 90) + 'px;padding: 0;"><div> 0 - 10<input style="opacity: 1;margin-top: 9px;margin-left: 5px !important;" type="radio" class="btn btn-primary" name="age' + i + '"></div><div>10 - 18 <input style="opacity: 1;margin-top: 9px;margin-left: 5px !important;" type="radio" class="btn btn-primary" name="age' + i + '"></div>');
    //     }
    //   } else if ($(this).val() == '3 children') {
    //     number = 2;
    //     $('.addCalcTourJquery').remove();
    //     for (let i = 0; i <= number; i++) {
    //       $('.addCalcTour').append('<div class="addCalcTourJquery one-third2 widthAuto" style="position: absolute;right: ' + (180 - i * 90) + 'px;padding: 0;"><div> 0 - 10<input style="opacity: 1;margin-top: 9px;margin-left: 5px !important;" type="radio" class="btn btn-primary" name="age' + i + '"></div><div>10 - 18 <input style="opacity: 1;margin-top: 9px;margin-left: 5px !important;" type="radio" class="btn btn-primary" name="age' + i + '"></div>');
